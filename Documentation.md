...
10. Click **Generate token**--> Copy and past link into **password line** in Jenkins
...
13. For this deployment, there was an included packaging/zip command within my applicaion code that compressed my GitHub file. Under the packaging phase in the console output, the location of the file within the EC2 home directory was given:
