...
7. Click **[Upload and Deploy]** --> Upload newly compressed zip file from [**Step 1** under **MERGE**] --> Wait for **Elastic Beanstalk** to upload application code, create correct application version and deploy web application -->Copy & Paste **"Domain Link"** (*as seen in the previous image attachment*) into a new browser to further check for successful deployment of my web application.
